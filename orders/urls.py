...
urlpatterns = [path('', views.home, name='home'),
               ...
               path('api/product', views.Product.as_view(), name='api-product'),
               path('api/supplier', views.Supplier.as_view(), name='api-supplier'),
               path('api/input', views.Input.as_view(), name='api-input'),
               ...
               path('messages', views.ListMessages.as_view(), name='messages'),
               ...
               path('new_message', views.MessageCreation.as_view(), name='new_message'),
